...
\subsection{Etiquetado del \textit{dataset}}

El conjunto de datos dado por el cliente fue etiquetado utilizando una herramienta llamada \textit{Roboflow}. El etiquetado con \textit{Roboflow} es simple y se puede utilizar para múltiples tareas relacionadas a visión por computadora. Por otro lado, el presente trabajo requirió varios etiquetados del mismo \textit{dataset}, debido a, los distintos modelos que se entrenaron para su realización.
...
\begin{table}[h]
	\centering
	\caption[caption corto]{Cantidad de fotos etiquetadas por modelo}
