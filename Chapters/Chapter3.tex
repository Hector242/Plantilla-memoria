...
Por otro lado, como se utilizó la biblioteca de Pytorch para el desarrollo del modelo \textit{Faster R-CNN} y el clasificador de flores, fue necesario transformar las imágenes a un formato de tensor. Esto es un requerimiento de implementación de dicha biblioteca para manipular la imágenes y que puedan ser consumidas por los modelos. 
