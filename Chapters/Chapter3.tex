...
En las fotos provistas por el INTA, como se menciona en la sección \ref{section3.2.1}, contienen una regla de 30 centímetros de largo y 5 de ancho. Esta regla se utilizó como objeto de referencia para la estimación de longitud de las varetas. Por otro lado, para su detección se tuvo que entrenar un modelo con \textit{transfer learning}. El modelo base utilizado era YOLOv8n de Ultralytics que fue preentrenado con el conjunto de datos de COCO.
