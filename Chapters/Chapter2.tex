...
Por otro lado, se tienen métodos de \textit{deep learning} para detección de objetos más avanzados que involucran detectores de dos etapas y de una etapa como son \textit{R-CNN}, \textit{Faster-RCNN}, \textit{SSD}, \textit{YOLO}, entre otros.
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=.2]{./Figures/R-CNN.png}
